...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-surface border border-border shadow-2xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-200 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col gap-1 border-b border-border p-6 text-left",
      className
    )}
    {...props}
  />
